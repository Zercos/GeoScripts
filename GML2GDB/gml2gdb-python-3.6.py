...
def download_unzip():
    ...
    urllib.request.urlretrieve("ftp://91.223.135.109/prg/punkty_adresowe.zip", "TEMP\\puntky_adresowe.zip")
    urllib.request.urlretrieve("ftp://91.223.135.109/prg/jednostki_administracyjne.zip",
                               "TEMP\\jednostki_administracyjne.zip")
...
arcpy.AddField_management(fc, 'nowaUlica', "TEXT", field_length=2048)
arcpy.AddField_management(fc, 'nowaMiejscowosc', "TEXT", field_length=2048)
